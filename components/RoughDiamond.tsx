...
type RoughDiamondProps = {
  ...
  isSelected: boolean;
  onSelect: () => void;
  onChange: (newProps: RoughDiamondProps) => void;
  transformerRef: React.RefObject<Konva.Transformer | null>;
};

const RoughDiamond = (props: RoughDiamondProps) => {
